...
const eventIcons = {
  ...
  DISPATCH_ASSIGNED: Truck,
  DISPATCH_PICKED_UP: Truck,
  DISPATCH_IN_TRANSIT: Truck,
...
const eventLabels = {
  ...
  OrderPrepared: 'Order Ready',
  ORDER_PREPARED: 'Order Ready',
  ...
  DISPATCH_ASSIGNED: 'Driver Assigned',
  DISPATCH_PICKED_UP: 'Picked Up',
  DISPATCH_IN_TRANSIT: 'Out for Delivery',
